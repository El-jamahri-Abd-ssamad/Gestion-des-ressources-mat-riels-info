-- Exécutez d'abord pour créer la base
...
CREATE TABLE BlacklistEntry (
    ...
    CreatedBy INT NOT NULL,
    CONSTRAINT FK_Blacklist_Supplier FOREIGN KEY (IdSupplier) REFERENCES Supplier(Id),
    CONSTRAINT FK_Blacklist_User FOREIGN KEY (CreatedBy) REFERENCES [User](Id)
);

-- Index
CREATE INDEX IX_TenderStatus ON Tender(Status);
CREATE INDEX IX_Offer_Tender ON Offer(IdTender);
CREATE INDEX IX_Offer_Supplier ON Offer(IdSupplier);
CREATE INDEX IX_Supplier_User ON Supplier(IdUser);

-- Données de test
INSERT INTO Account (Username, Password, Role) 
VALUES ('admin', 'admin123', 'Admin');

INSERT INTO [User] (Name, Email, Phone, DateBirth, IdAccount)
VALUES ('Administrateur', 'admin@example.com', '0600000000', '1990-01-01', 1);
GO